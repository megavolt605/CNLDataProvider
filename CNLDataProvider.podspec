#
#  Be sure to run `pod spec lint CNLDataProvider.podspec' to ensure this is a
...
Commonly used in other Complex Numbers projects.
  ...
  # s.xcconfig = { 'SWIFT_INCLUDE_PATHS' => '$(PODS_ROOT)/CNLDataProvider/CNLFoundationTools/CommonCrypto' }
